...
module.exports = merge(common, {
    ...
    plugins: [
        ...
        // new OpenBrowserPlugin({url: 'http://localhost:8021' + PATHS.publicPath + 'index.html'})
        new OpenBrowserPlugin({
            url: 'http://localhost:8321/src/index.html'
        })
    ],
    ...
    devServer: {
        ...
        port: "8321",  // Defaults to 8080   process.env.PORT
    ...
    // 开发 eval-source-map cheap-module-eval-source-map
